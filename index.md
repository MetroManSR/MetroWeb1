<button class="button" role="button" onclick="location.href='en/index'"> English </button>

<button class="button" role="button" onclick="location.href='balkeon/index'"> Aprende Balkeon </button>
