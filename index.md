<a href="en/index" class="button">English</a>
<a href="balkeon/index" class="button">Aprende Balkeon</a>

<button class="button" role="button" onclick="location.href='balkeon/index'">Click Me</button>
